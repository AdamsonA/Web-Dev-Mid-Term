                                ...
                                <div class="form-row">
                                  ...
                                  <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" class="form-control">
                                      ...
                                      <option selected>Saskatchewan</option>
                                      <option selected>Quebec</option>
                                      <option selected>New Brunswick</option>
                                      <option selected>Nova Scotia</option>
                                      <option selected>Prince Edward Island</option>
                                      <option selected>Newfoundland and Labrador</option>
